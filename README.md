Here’s an updated version of your `README.md` to reflect that this is now a **new package** based on `open_file_plus`, with clarified usage and branding under `another_open_file`.
